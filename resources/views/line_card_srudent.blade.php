...
<body>
    <section class="background-color: #f4f4f4; ">
        <div  style="width:100%">
            ...
            <div style="">
        <table style="width:40%; top:-100px;">
                <tbody style="background-color: #f4f4f4; "><tr>
                  <td width="32%" rowspan="6" align="center"><img src="https://reg.buu.ac.th/registrar/nurseGetImg.asp?id={{$iddd}}" style="width:130px; padding-top:0px; padding-left:20px; padding-right:15px; display:inline; text-align:left; vertical-align: top;"><br><font style="  font-size:10px; color:#000093;">บัตรประจำตัวนิสิต</font></td>
                  <td width="68%"><img src="https://buu-oss.buu.ac.th/theme/images/logo_card_1.jpg" style="padding-top:60px; padding-left:5px; display:inline; text-align:center ;vertical-align: top;"></td>
                </tr>
                <tr>
